...
"   ")
        ...
        self.m_page1_flock.setGeometry(QRect(0, 0, 326, 535))
        ...
        self.m_flockSpeedSlider.setOrientation(Qt.Orientation.Horizontal)
        ...
        self.m_page2_obstacle.setGeometry(QRect(0, 0, 326, 535))
        ...
        self.m_obstacleAvoidanceRadiusSlider.setOrientation(Qt.Orientation.Horizontal)
        ...
        self.m_obstacleCollisionRadiusSlider.setOrientation(Qt.Orientation.Horizontal)
        ...
        self.m_obstacleRepulsionForceSlider.setOrientation(Qt.Orientation.Horizontal)
        ...
        self.m_page3_simulation.setGeometry(QRect(0, 0, 326, 535))
        ...
        self.m_simDistanceSlider = QSlider(self.groupBox_7)
        self.m_simDistanceSlider.setObjectName(u"m_simDistanceSlider")
        self.m_simDistanceSlider.setMinimum(10)
        self.m_simDistanceSlider.setMaximum(100)
        self.m_simDistanceSlider.setValue(20)
        self.m_simDistanceSlider.setOrientation(Qt.Orientation.Horizontal)
        self.m_simDistanceSlider.setTickPosition(QSlider.TickPosition.TicksBelow)
        self.m_simDistanceSlider.setTickInterval(1)

        self.gridLayout_7.addWidget(self.m_simDistanceSlider, 1, 0, 1, 1)

        self.m_simDistanceValue = QLabel(self.groupBox_7)
        self.m_simDistanceValue.setObjectName(u"m_simDistanceValue")

        self.gridLayout_7.addWidget(self.m_simDistanceValue, 1, 1, 1, 1)
        ...
        self.m_simFlockDistanceSlider = QSlider(self.groupBox_7)
        self.m_simFlockDistanceSlider.setObjectName(u"m_simFlockDistanceSlider")
        self.m_simFlockDistanceSlider.setMinimum(1)
        self.m_simFlockDistanceSlider.setMaximum(10)
        self.m_simFlockDistanceSlider.setValue(4)
        self.m_simFlockDistanceSlider.setOrientation(Qt.Orientation.Horizontal)
        self.m_simFlockDistanceSlider.setTickPosition(QSlider.TickPosition.TicksBelow)
        self.m_simFlockDistanceSlider.setTickInterval(1)

        self.gridLayout_7.addWidget(self.m_simFlockDistanceSlider, 3, 0, 1, 1)

        self.m_simFlockDistanceValue = QLabel(self.groupBox_7)
        self.m_simFlockDistanceValue.setObjectName(u"m_simFlockDistanceValue")

        self.gridLayout_7.addWidget(self.m_simFlockDistanceValue, 3, 1, 1, 1)
        ...
        self.m_simCohesionSlider = QSlider(self.groupBox_7)
        self.m_simCohesionSlider.setObjectName(u"m_simCohesionSlider")
        self.m_simCohesionSlider.setMinimum(0)
        self.m_simCohesionSlider.setMaximum(10)
        self.m_simCohesionSlider.setValue(2)
        self.m_simCohesionSlider.setOrientation(Qt.Orientation.Horizontal)
        self.m_simCohesionSlider.setTickPosition(QSlider.TickPosition.TicksBelow)
        self.m_simCohesionSlider.setTickInterval(1)

        self.gridLayout_7.addWidget(self.m_simCohesionSlider, 5, 0, 1, 1)

        self.m_simCohesionValue = QLabel(self.groupBox_7)
        self.m_simCohesionValue.setObjectName(u"m_simCohesionValue")

        self.gridLayout_7.addWidget(self.m_simCohesionValue, 5, 1, 1, 1)
        ...
        self.m_simSeparationSlider = QSlider(self.groupBox_7)
        self.m_simSeparationSlider.setObjectName(u"m_simSeparationSlider")
        self.m_simSeparationSlider.setMinimum(0)
        self.m_simSeparationSlider.setMaximum(20)
        self.m_simSeparationSlider.setValue(9)
        self.m_simSeparationSlider.setOrientation(Qt.Orientation.Horizontal)
        self.m_simSeparationSlider.setTickPosition(QSlider.TickPosition.TicksBelow)
        self.m_simSeparationSlider.setTickInterval(1)

        self.gridLayout_7.addWidget(self.m_simSeparationSlider, 7, 0, 1, 1)

        self.m_simSeparationValue = QLabel(self.groupBox_7)
        self.m_simSeparationValue.setObjectName(u"m_simSeparationValue")

        self.gridLayout_7.addWidget(self.m_simSeparationValue, 7, 1, 1, 1)
        ...
        self.m_simAlignmentSlider = QSlider(self.groupBox_7)
        self.m_simAlignmentSlider.setObjectName(u"m_simAlignmentSlider")
        self.m_simAlignmentSlider.setMinimum(0)
        self.m_simAlignmentSlider.setMaximum(20)
        self.m_simAlignmentSlider.setValue(10)
        self.m_simAlignmentSlider.setOrientation(Qt.Orientation.Horizontal)
        self.m_simAlignmentSlider.setTickPosition(QSlider.TickPosition.TicksBelow)
        self.m_simAlignmentSlider.setTickInterval(1)

        self.gridLayout_7.addWidget(self.m_simAlignmentSlider, 9, 0, 1, 1)

        self.m_simAlignmentValue = QLabel(self.groupBox_7)
        self.m_simAlignmentValue.setObjectName(u"m_simAlignmentValue")

        self.gridLayout_7.addWidget(self.m_simAlignmentValue, 9, 1, 1, 1)
        ...
        self.m_page4_environment.setGeometry(QRect(0, 0, 326, 535))
        ...
        QWidget.setTabOrder(self.m_obstacleWireframe, self.m_bboxSize)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.m_simDistanceValue.setText(QCoreApplication.translate("MainWindow", u"20.0", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"Flock Distance", None))
        self.m_simFlockDistanceValue.setText(QCoreApplication.translate("MainWindow", u"4.0", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Cohesion Force :", None))
        self.m_simCohesionValue.setText(QCoreApplication.translate("MainWindow", u"2.0", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Separation Force :", None))
        self.m_simSeparationValue.setText(QCoreApplication.translate("MainWindow", u"9.0", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Alignment Weight :", None))
        self.m_simAlignmentValue.setText(QCoreApplication.translate("MainWindow", u"10.0", None))
